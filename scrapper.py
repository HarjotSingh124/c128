...
# NASA Exoplanet URL
START_URL = "https://en.wikipedia.org/wiki/List_of_brightest_stars_and_other_record_stars?action=edit"
# Webdriver
...
headers = ["name", "bayer designation", "distance(ly)", "spectral class", "mass", "radius", 
            "luminosity"]
...
def scrape():
    for i in range(1,5):
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "stars"}):
            ...
            temp_list.append("https://en.wikipedia.org/wiki/List_of_brightest_stars_and_other_record_stars?action=edit"+ hyperlink_li_tag.find_all("a", href=True)[0]["href"])
